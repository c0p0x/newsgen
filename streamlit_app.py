...
def summarize_text(to_summarize_texts, openai_api_key):
    ...
    prompt = PromptTemplate(
            ...
            template="Write an appropriate, clickbaity news article title in Polish for less then approximatetly 150 characters for this text: {text}. Please prepare 3 versions in a list so I can choose."
        )
